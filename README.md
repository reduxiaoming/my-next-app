...
npm run dev</code></pre>
    <div class="markdown-heading">
        <h3class="heading-element">一起启动前后端</h3>
    </div>
    <p>为了便于调试，也可以一起启动前后端：</p>
<pre><code>npm run dev</code></pre>
    <div class="markdown-heading">
        <h2class="heading-element">项目结构</h2>
    </div>
