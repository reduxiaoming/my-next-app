<div dir="auto">
    <div class="markdown-heading" dir="auto">
        <h1 class="heading-element" dir="auto">My Next App</h1>
    </div>
    <p dir="auto">这是一个基于 Next.js 和 Node.js 的全栈项目，使用 PostgreSQL 作为数据库。以下是构建和运行该项目的详细步骤。</p>
    <div class="markdown-heading" dir="auto">
        <h2 class="heading-element" dir="auto">前提条件</h2>
    </div>
    <ol dir="auto">
        <li>
    ...
    <div class="markdown-heading" dir="auto">
        <h2 class="heading-element" dir="auto">克隆项目</h2>
    </div>
...
cd my-next-app</code></pre>
    <div class="markdown-heading" dir="auto">
        <h2 class="heading-element" dir="auto">环境配置</h2>
    </div>
...
API_BASE_URL=http://localhost:3001/api</code></pre>
    ...
    <div class="markdown-heading" dir="auto">
        <h2 class="heading-element" dir="auto">安装依赖</h2>
    </div>
    <p dir="auto">在克隆的项目目录中，安装所需的依赖包：</p>
<pre><code>npm install</code></pre>
    <div class="markdown-heading" dir="auto">
        <h2 class="heading-element" dir="auto">数据库初始化</h2>
    </div>
    <p dir="auto">在第一次运行项目之前，需要初始化数据库。确保 PostgreSQL 已经运行，然后执行以下命令：</p>
<pre><code>npx ts-node backend/utils/dbInit.ts</code></pre>
    <div class="markdown-heading" dir="auto">
        <h2 class="heading-element" dir="auto">运行项目</h2>
    </div>
    <div class="markdown-heading" dir="auto">
        <h3 class="heading-element" dir="auto">分别启动前后端</h3>
    </div>
    <ol dir="auto">
        <li>启动后端：</li>
    </ol>
...
npm run dev</code></pre>
    <div class="markdown-heading" dir="auto">
        <h3 class="heading-element" dir="auto">一起启动前后端</h3>
    </div>
    <p dir="auto">为了便于调试，也可以一起启动前后端：</p>
<pre><code>npm run dev</code></pre>
    <div class="markdown-heading" dir="auto">
        <h2 class="heading-element" dir="auto">项目结构</h2>
    </div>
